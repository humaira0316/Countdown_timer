...
class Countdowntimer:
    def __init__(self):
        ...
        self.start_button = tk.Button(self.root, font=("Helvetica", 30), text="Start", command=self.start_thread)#extra thread so we can interact with the UI midway otherwise Time will stop that from happening
